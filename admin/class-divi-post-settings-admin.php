	...
	if( $options['action'] == 'update' && $options['type'] == 'plugin' && isset( $options['plugins'] ) ) {
	 ...
	 foreach( $options['plugins'] as $plugin ) {
	  if( $plugin == $our_plugin ) {
	   ...
	   set_transient( 'wp_idivi_updated', 1 );
	  }
	 }
	}
   }
...
function display_update_notice() {
	...
	if( get_transient( 'wp_idivi_updated' ) ) {
	 echo '<div class="notice notice-info is-dismissible">' . __( '<p><b>NOTE:</b> If you have updated from a previous plugin version you should save again your settings from the Theme Customizer.</p>', 'wp-upe' ) . '</div>';
	 delete_transient( 'wp_idivi_updated' );
	}
   }
 ...
 */
    ...
    /**
     * Sync the Theme Mods at first launch of the Visual Builder.
     *
     * @since   1.3
     *
     */
    /* public function idivi_sync_theme_mods()
    {
        // GET CUSTOMIZER OPTIONS IF SET
        $layout_setting_option_post = get_option('idivi_post_settings_sidebar');
        $layout_setting_option_product = get_option('idivi_product_settings_sidebar');
		
		$dot_option_post = get_option('idivi_post_settings_dot');
		$dot_option_page = get_option('idivi_page_settings_dot');
		$dot_option_project = get_option('idivi_project_settings_dot');
		$dot_option_product = get_option('idivi_product_settings_dot');
		
		$hide_before_setting_option_post = get_option('idivi_post_settings_before_scroll');
		$hide_before_setting_option_page = get_option('idivi_page_settings_before_scroll');
		$hide_before_setting_option_project = get_option('idivi_project_settings_before_scroll');
		$hide_before_setting_option_product = get_option('idivi_product_settings_before_scroll');
		
		$show_title_setting_option = get_option('idivi_post_settings_post_title');
        $project_nav_setting_option = get_option('idivi_project_settings_nav');

        // if set options convert it to theme mods
        isset($layout_setting_option_post) ? set_theme_mod('idivi_post_settings_sidebar', $layout_setting_option_post) : get_theme_mod('idivi_post_settings_sidebar');
        isset($layout_setting_option_product) ? set_theme_mod('idivi_product_settings_sidebar', $layout_setting_option_product) : get_theme_mod('idivi_product_settings_sidebar');
		
		isset($dot_option_post) ? set_theme_mod('idivi_post_settings_dot', $dot_option_post) : get_theme_mod('idivi_post_settings_dot');
		isset($dot_option_page) ? set_theme_mod('idivi_page_settings_dot', $dot_option_page) : get_theme_mod('idivi_page_settings_dot');
		isset($dot_option_project) ? set_theme_mod('idivi_project_settings_dot', $dot_option_project) : get_theme_mod('idivi_project_settings_dot');
		isset($dot_option_product) ? set_theme_mod('idivi_product_settings_dot', $dot_option_product) : get_theme_mod('idivi_product_settings_dot');
		
		isset($hide_before_setting_option_post) ? set_theme_mod('idivi_post_settings_before_scroll', $hide_before_setting_option_post) : get_theme_mod('idivi_post_settings_before_scroll');
		isset($hide_before_setting_option_page) ? set_theme_mod('idivi_page_settings_before_scroll', $hide_before_setting_option_page) : get_theme_mod('idivi_page_settings_before_scroll');
		isset($hide_before_setting_option_project) ? set_theme_mod('idivi_project_settings_before_scroll', $hide_before_setting_option_project) : get_theme_mod('idivi_project_settings_before_scroll');
		isset($hide_before_setting_option_product) ? set_theme_mod('idivi_product_settings_before_scroll', $hide_before_setting_option_product) : get_theme_mod('idivi_product_settings_before_scroll');
		
		isset($show_title_setting_option) ? set_theme_mod('idivi_post_settings_post_title', $show_title_setting_option) : get_theme_mod('idivi_post_settings_post_title');
		isset($project_nav_setting_option) ? set_theme_mod('idivi_project_settings_nav', $project_nav_setting_option) : get_theme_mod('idivi_project_settings_nav');

		// then delete options
		delete_option('idivi_post_settings_sidebar');
        delete_option('idivi_product_settings_sidebar');
		delete_option('idivi_post_settings_dot');
		delete_option('idivi_page_settings_dot');
		delete_option('idivi_project_settings_dot');
		delete_option('idivi_product_settings_dot');
		
		delete_option('idivi_post_settings_before_scroll');
		delete_option('idivi_page_settings_before_scroll');
		delete_option('idivi_project_settings_before_scroll');
		delete_option('idivi_product_settings_before_scroll');
		
		delete_option('idivi_post_settings_post_title');
        delete_option('idivi_project_settings_nav');
    }
 */
/**
 ...
 *
 */
    public function set_initial_theme_mods_values()
    {
        $post_id = get_the_ID();
